...
void draw_log(void)
{
    ...
    int start =
        qso_count > visible ? qso_count - visible : 0;
...
void draw_stats(void)
{
    ...
    mvwprintw(
        ...
        1,
        1,
        "CW:%d SSB:%d FT8:%d FT4:%d RTTY:%d PSK31:%d",
        stats.cw,
        stats.ssb,
        stats.ft8,
        stats.ft4,
...
void draw_cluster_fullscreen(int scroll)
{
    ...
    mvwprintw(
        ...
        rows - 1,
        1,
        "UP/DOWN scroll  PgUp/PgDn page  F4 return  %d/%d",
        scroll + 1,
        max_scroll + 1);
...
void draw_function_bar(void)
{
    ...
    mvwprintw(
        ...
        0,
        1,
        "F1 Help  F2 Export  F3 Stats  F4 Cluster  F10 Quit");
